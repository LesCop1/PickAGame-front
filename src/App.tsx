...
export default function App() {
  return (
    <div className="flex flex-col size-fit items-center justify-center gap-pag-spacing-300">
      <img src={PagLogo} alt="PickAGame Logo" className="h-pag-sizing-1300" />
      <span className="text-pag-2xl">Welcome back!</span>
